// ═══════════════════════════════════════════════════════════════
// PEGAR EN resident_main_navigation.dart
// ═══════════════════════════════════════════════════════════════

// MÉTODO 1: Agregar después de _loadCondos()
// ─────────────────────────────────────────────
      ...
      if (res['status'] == 'success' && res['data'] != null) {
        ...
        if (mounted) {
          setState(() {
            ...
            if (currentId != null) _activeUnitId = int.tryParse(currentId.toString());
            _loadingUnits = false;
          });
        }
      } else {
...
// MÉTODO 2: Agregar antes de _buildDrawer()
// ─────────────────────────────────────────────
...
// INSERCIÓN EN DRAWER: Dentro de _buildDrawer(), en el ListView,
// DESPUÉS del Container del header (avatar/nombre/badge),
// ANTES del Padding de "TUS COMUNIDADES", agregar:
//
//   _buildUnitSelector(),
